...
LaserBumpAndRunStrategy::LaserBumpAndRunStrategy()
{
    _turning = false;
    _movingForward = true;
}

geometry_msgs::Twist LaserBumpAndRunStrategy::step(BumperData bumperData, LaserData laserData, OdomData odomData, uint64_t secondsElapsed)
{
